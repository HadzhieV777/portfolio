...
export const metadata: Metadata = {
  ...
  description:
    "Radoslav is a seasoned Fullstack Software Developer. With a passion for crafting seamless, innovative solutions, bringing a unique blend of technical prowess and marketing acumen to the digital landscape.",
};
